...
# Use the test preset: 1 minute focus, 1 minute short break, 1 minute long break, 1 cycle
cmd = ["uv", "run", "pomlock", "--timer", "test"]
...
print("Waiting 15 seconds to observe behavior...")
time.sleep(15)
